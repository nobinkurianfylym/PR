...
var BuildId = "QNJDbHteyjPap958i8z4W";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/admin/broadcasts/route": "/api/admin/broadcasts", "/api/admin/fans/export/route": "/api/admin/fans/export", "/api/admin/fans/route": "/api/admin/fans", "/api/assets/route": "/api/assets", "/api/assets/[id]/route": "/api/assets/[id]", "/api/auth/signin/route": "/api/auth/signin", "/api/auth/signup/route": "/api/auth/signup", "/api/auth/signout/route": "/api/auth/signout", "/api/brain/route": "/api/brain", "/api/competitors/route": "/api/competitors", "/api/films/publish/route": "/api/films/publish", "/api/competitors/[id]/route": "/api/competitors/[id]", "/api/films/[id]/route": "/api/films/[id]", "/api/films/select/route": "/api/films/select", "/api/films/route": "/api/films", "/api/films/submissions/route": "/api/films/submissions", "/api/members/[userId]/route": "/api/members/[userId]", "/api/invite/rotate/route": "/api/invite/rotate", "/api/me/route": "/api/me", "/api/links/route": "/api/links", "/api/join/[token]/route": "/api/join/[token]", "/api/opportunities/[id]/route": "/api/opportunities/[id]", "/api/members/route": "/api/members", "/api/missions/route": "/api/missions", "/api/missions/[id]/route": "/api/missions/[id]", "/api/opportunities/route": "/api/opportunities", "/api/overview/route": "/api/overview", "/api/press/[slug]/links/route": "/api/press/[slug]/links", "/api/press/[slug]/fans/route": "/api/press/[slug]/fans", "/api/shared-links/[id]/route": "/api/shared-links/[id]", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/api/shared-links/route": "/api/shared-links", "/api/reviews/route": "/api/reviews", "/api/team/route": "/api/team", "/page": "/", "/press/[slug]/page": "/press/[slug]", "/join/[token]/page": "/join/[token]", "/press/[slug]/a/[assetId]/page": "/press/[slug]/a/[assetId]", "/(app)/admin/page": "/admin", "/(app)/assets/page": "/assets", "/(app)/campaign/page": "/campaign", "/(app)/films/new/page": "/films/new", "/(app)/dashboard/page": "/dashboard", "/(app)/reviews/page": "/reviews", "/(app)/team/page": "/team", "/(app)/films/edit/page": "/films/edit", "/(app)/brain/page": "/brain", "/(auth)/signin/page": "/signin", "/(auth)/signup/page": "/signup" };
