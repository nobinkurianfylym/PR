...
var BuildId = "85MG4yiV1n3LVcHw1TQFK";
var HtmlPages = ["/404"];
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/assets", "regex": "^/assets(?:/)?$", "routeKeys": {}, "namedRegex": "^/assets(?:/)?$" }, { "page": "/brain", "regex": "^/brain(?:/)?$", "routeKeys": {}, "namedRegex": "^/brain(?:/)?$" }, { "page": "/campaign", "regex": "^/campaign(?:/)?$", "routeKeys": {}, "namedRegex": "^/campaign(?:/)?$" }, { "page": "/dashboard", "regex": "^/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard(?:/)?$" }, { "page": "/films/edit", "regex": "^/films/edit(?:/)?$", "routeKeys": {}, "namedRegex": "^/films/edit(?:/)?$" }, { "page": "/films/new", "regex": "^/films/new(?:/)?$", "routeKeys": {}, "namedRegex": "^/films/new(?:/)?$" }, { "page": "/reviews", "regex": "^/reviews(?:/)?$", "routeKeys": {}, "namedRegex": "^/reviews(?:/)?$" }, { "page": "/signin", "regex": "^/signin(?:/)?$", "routeKeys": {}, "namedRegex": "^/signin(?:/)?$" }, { "page": "/signup", "regex": "^/signup(?:/)?$", "routeKeys": {}, "namedRegex": "^/signup(?:/)?$" }, { "page": "/team", "regex": "^/team(?:/)?$", "routeKeys": {}, "namedRegex": "^/team(?:/)?$" }], "dynamic": [{ "page": "/api/assets/[id]", "regex": "^/api/assets/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/assets/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/competitors/[id]", "regex": "^/api/competitors/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/competitors/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/films/[id]", "regex": "^/api/films/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/films/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/missions/[id]", "regex": "^/api/missions/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/missions/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/opportunities/[id]", "regex": "^/api/opportunities/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/opportunities/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/press/[slug]/links", "regex": "^/api/press/([^/]+?)/links(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/press/(?<nxtPslug>[^/]+?)/links(?:/)?$" }, { "page": "/api/press/[slug]/submit", "regex": "^/api/press/([^/]+?)/submit(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/press/(?<nxtPslug>[^/]+?)/submit(?:/)?$" }, { "page": "/api/shared-links/[id]", "regex": "^/api/shared\\-links/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/shared\\-links/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/press/[slug]", "regex": "^/press/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/press/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/press/[slug]/a/[assetId]", "regex": "^/press/([^/]+?)/a/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug", "nxtPassetId": "nxtPassetId" }, "namedRegex": "^/press/(?<nxtPslug>[^/]+?)/a/(?<nxtPassetId>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/auth/signin/route": "/api/auth/signin", "/api/assets/route": "/api/assets", "/api/auth/signout/route": "/api/auth/signout", "/api/competitors/[id]/route": "/api/competitors/[id]", "/api/competitors/route": "/api/competitors", "/api/auth/signup/route": "/api/auth/signup", "/api/films/select/route": "/api/films/select", "/api/films/[id]/route": "/api/films/[id]", "/api/films/publish/route": "/api/films/publish", "/api/assets/[id]/route": "/api/assets/[id]", "/api/me/route": "/api/me", "/api/films/submissions/route": "/api/films/submissions", "/api/films/route": "/api/films", "/api/brain/route": "/api/brain", "/api/opportunities/[id]/route": "/api/opportunities/[id]", "/api/links/route": "/api/links", "/api/missions/[id]/route": "/api/missions/[id]", "/api/overview/route": "/api/overview", "/api/opportunities/route": "/api/opportunities", "/api/missions/route": "/api/missions", "/api/press/[slug]/links/route": "/api/press/[slug]/links", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/api/shared-links/[id]/route": "/api/shared-links/[id]", "/api/team/route": "/api/team", "/api/reviews/route": "/api/reviews", "/api/shared-links/route": "/api/shared-links", "/page": "/", "/(app)/assets/page": "/assets", "/(app)/dashboard/page": "/dashboard", "/(app)/campaign/page": "/campaign", "/(app)/reviews/page": "/reviews", "/(app)/films/edit/page": "/films/edit", "/(app)/films/new/page": "/films/new", "/(auth)/signin/page": "/signin", "/(app)/brain/page": "/brain", "/(app)/team/page": "/team", "/(auth)/signup/page": "/signup", "/press/[slug]/a/[assetId]/page": "/press/[slug]/a/[assetId]", "/press/[slug]/page": "/press/[slug]" };
