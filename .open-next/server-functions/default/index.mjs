...
var BuildId = "LJs_uQBaY2XzHZvpvXvly";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/api/auth/signout/route": "/api/auth/signout", "/api/assets/[id]/route": "/api/assets/[id]", "/api/auth/signin/route": "/api/auth/signin", "/api/assets/route": "/api/assets", "/api/films/[id]/route": "/api/films/[id]", "/api/auth/signup/route": "/api/auth/signup", "/api/films/route": "/api/films", "/api/brain/route": "/api/brain", "/api/films/select/route": "/api/films/select", "/api/competitors/route": "/api/competitors", "/api/competitors/[id]/route": "/api/competitors/[id]", "/api/films/publish/route": "/api/films/publish", "/api/films/submissions/route": "/api/films/submissions", "/api/links/route": "/api/links", "/api/opportunities/[id]/route": "/api/opportunities/[id]", "/api/opportunities/route": "/api/opportunities", "/api/missions/[id]/route": "/api/missions/[id]", "/api/me/route": "/api/me", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/api/missions/route": "/api/missions", "/api/shared-links/[id]/route": "/api/shared-links/[id]", "/api/overview/route": "/api/overview", "/api/press/[slug]/links/route": "/api/press/[slug]/links", "/api/shared-links/route": "/api/shared-links", "/api/team/route": "/api/team", "/api/reviews/route": "/api/reviews", "/_not-found/page": "/_not-found", "/page": "/", "/(app)/films/new/page": "/films/new", "/(app)/films/edit/page": "/films/edit", "/(app)/campaign/page": "/campaign", "/(app)/team/page": "/team", "/(app)/brain/page": "/brain", "/(app)/dashboard/page": "/dashboard", "/(app)/reviews/page": "/reviews", "/(auth)/signin/page": "/signin", "/(auth)/signup/page": "/signup", "/(app)/assets/page": "/assets", "/press/[slug]/page": "/press/[slug]" };
