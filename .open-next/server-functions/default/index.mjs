...
var BuildId = "nGMAsoib11Ct0pGR2xhT6";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/assets/[id]/route": "/api/assets/[id]", "/api/auth/signin/route": "/api/auth/signin", "/api/auth/signout/route": "/api/auth/signout", "/api/assets/route": "/api/assets", "/api/films/[id]/route": "/api/films/[id]", "/api/films/publish/route": "/api/films/publish", "/api/films/select/route": "/api/films/select", "/api/films/submissions/route": "/api/films/submissions", "/api/me/route": "/api/me", "/api/auth/signup/route": "/api/auth/signup", "/api/overview/route": "/api/overview", "/api/missions/[id]/route": "/api/missions/[id]", "/api/films/route": "/api/films", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/api/team/route": "/api/team", "/api/reviews/route": "/api/reviews", "/page": "/", "/press/[slug]/page": "/press/[slug]", "/(app)/assets/page": "/assets", "/(app)/films/edit/page": "/films/edit", "/(app)/campaign/page": "/campaign", "/(app)/reviews/page": "/reviews", "/(app)/team/page": "/team", "/(app)/films/new/page": "/films/new", "/(auth)/signup/page": "/signup", "/(auth)/signin/page": "/signin", "/(app)/dashboard/page": "/dashboard" };
