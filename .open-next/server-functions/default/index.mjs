...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/assets/[id]/route": "/api/assets/[id]", "/api/auth/signin/route": "/api/auth/signin", "/api/assets/route": "/api/assets", "/api/films/[id]/route": "/api/films/[id]", "/api/auth/signout/route": "/api/auth/signout", "/api/auth/signup/route": "/api/auth/signup", "/api/films/publish/route": "/api/films/publish", "/api/films/submissions/route": "/api/films/submissions", "/api/links/route": "/api/links", "/api/films/select/route": "/api/films/select", "/api/me/route": "/api/me", "/api/films/route": "/api/films", "/api/missions/[id]/route": "/api/missions/[id]", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/api/overview/route": "/api/overview", "/api/reviews/route": "/api/reviews", "/api/team/route": "/api/team", "/page": "/", "/(app)/assets/page": "/assets", "/(app)/team/page": "/team", "/(app)/dashboard/page": "/dashboard", "/(app)/reviews/page": "/reviews", "/(app)/campaign/page": "/campaign", "/(app)/films/new/page": "/films/new", "/(auth)/signin/page": "/signin", "/(auth)/signup/page": "/signup", "/(app)/films/edit/page": "/films/edit", "/press/[slug]/page": "/press/[slug]" };
