...
var BuildId = "gOfpJ05YWdWYtR4hWXJYL";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/auth/signin/route": "/api/auth/signin", "/api/auth/signout/route": "/api/auth/signout", "/api/auth/signup/route": "/api/auth/signup", "/api/me/route": "/api/me", "/api/missions/[id]/route": "/api/missions/[id]", "/api/overview/route": "/api/overview", "/api/films/route": "/api/films", "/api/team/route": "/api/team", "/api/reviews/route": "/api/reviews", "/page": "/", "/(app)/assets/page": "/assets", "/(app)/campaign/page": "/campaign", "/(app)/dashboard/page": "/dashboard", "/(app)/team/page": "/team", "/(auth)/signup/page": "/signup", "/(auth)/signin/page": "/signin", "/(app)/films/new/page": "/films/new", "/(app)/reviews/page": "/reviews" };
