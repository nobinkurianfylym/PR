...
var AppPathRoutesManifest = { "/api/assets/[id]/route": "/api/assets/[id]", "/api/auth/signout/route": "/api/auth/signout", "/api/assets/route": "/api/assets", "/api/auth/signin/route": "/api/auth/signin", "/api/auth/signup/route": "/api/auth/signup", "/api/films/[id]/route": "/api/films/[id]", "/api/films/route": "/api/films", "/api/films/select/route": "/api/films/select", "/api/me/route": "/api/me", "/api/overview/route": "/api/overview", "/api/missions/[id]/route": "/api/missions/[id]", "/api/reviews/route": "/api/reviews", "/api/team/route": "/api/team", "/_not-found/page": "/_not-found", "/page": "/", "/(app)/campaign/page": "/campaign", "/(app)/films/edit/page": "/films/edit", "/(app)/dashboard/page": "/dashboard", "/(app)/assets/page": "/assets", "/(app)/reviews/page": "/reviews", "/(app)/team/page": "/team", "/(app)/films/new/page": "/films/new", "/(auth)/signin/page": "/signin", "/(auth)/signup/page": "/signup" };
