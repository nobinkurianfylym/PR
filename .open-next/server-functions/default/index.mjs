...
var BuildId = "AxJNCk1-BG-dY0kzeXdVU";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/api/assets/[id]/route": "/api/assets/[id]", "/api/auth/signup/route": "/api/auth/signup", "/api/auth/signout/route": "/api/auth/signout", "/api/brain/route": "/api/brain", "/api/competitors/[id]/route": "/api/competitors/[id]", "/api/auth/signin/route": "/api/auth/signin", "/api/competitors/route": "/api/competitors", "/api/films/[id]/route": "/api/films/[id]", "/api/assets/route": "/api/assets", "/api/films/route": "/api/films", "/api/films/select/route": "/api/films/select", "/api/films/publish/route": "/api/films/publish", "/api/me/route": "/api/me", "/api/links/route": "/api/links", "/api/missions/[id]/route": "/api/missions/[id]", "/api/films/submissions/route": "/api/films/submissions", "/api/missions/route": "/api/missions", "/api/opportunities/[id]/route": "/api/opportunities/[id]", "/api/opportunities/route": "/api/opportunities", "/api/press/[slug]/links/route": "/api/press/[slug]/links", "/api/reviews/route": "/api/reviews", "/api/shared-links/[id]/route": "/api/shared-links/[id]", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/api/overview/route": "/api/overview", "/api/shared-links/route": "/api/shared-links", "/api/team/route": "/api/team", "/_not-found/page": "/_not-found", "/page": "/", "/(app)/assets/page": "/assets", "/(app)/dashboard/page": "/dashboard", "/(app)/brain/page": "/brain", "/(app)/films/new/page": "/films/new", "/(app)/team/page": "/team", "/(auth)/signin/page": "/signin", "/(auth)/signup/page": "/signup", "/(app)/reviews/page": "/reviews", "/(app)/campaign/page": "/campaign", "/(app)/films/edit/page": "/films/edit", "/press/[slug]/page": "/press/[slug]", "/press/[slug]/a/[assetId]/page": "/press/[slug]/a/[assetId]" };
