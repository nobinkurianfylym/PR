...
var BuildId = "zdrN1Re4WtGibo4cG8lUx";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/api/assets/[id]/route": "/api/assets/[id]", "/api/assets/route": "/api/assets", "/api/auth/signin/route": "/api/auth/signin", "/api/auth/signout/route": "/api/auth/signout", "/api/competitors/[id]/route": "/api/competitors/[id]", "/api/competitors/route": "/api/competitors", "/api/films/publish/route": "/api/films/publish", "/api/films/[id]/route": "/api/films/[id]", "/api/auth/signup/route": "/api/auth/signup", "/api/films/route": "/api/films", "/api/films/select/route": "/api/films/select", "/api/links/route": "/api/links", "/api/films/submissions/route": "/api/films/submissions", "/api/me/route": "/api/me", "/api/missions/[id]/route": "/api/missions/[id]", "/api/missions/route": "/api/missions", "/api/opportunities/[id]/route": "/api/opportunities/[id]", "/api/opportunities/route": "/api/opportunities", "/api/overview/route": "/api/overview", "/api/press/[slug]/links/route": "/api/press/[slug]/links", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/api/reviews/route": "/api/reviews", "/api/shared-links/[id]/route": "/api/shared-links/[id]", "/api/shared-links/route": "/api/shared-links", "/api/brain/route": "/api/brain", "/api/team/route": "/api/team", "/_not-found/page": "/_not-found", "/page": "/", "/(app)/films/edit/page": "/films/edit", "/(app)/films/new/page": "/films/new", "/(app)/campaign/page": "/campaign", "/(app)/brain/page": "/brain", "/(app)/dashboard/page": "/dashboard", "/(app)/assets/page": "/assets", "/(app)/reviews/page": "/reviews", "/(app)/team/page": "/team", "/(auth)/signup/page": "/signup", "/(auth)/signin/page": "/signin", "/press/[slug]/page": "/press/[slug]" };
