...
var AppPathRoutesManifest = { "/api/assets/[id]/route": "/api/assets/[id]", "/api/auth/signup/route": "/api/auth/signup", "/api/auth/signout/route": "/api/auth/signout", "/api/competitors/[id]/route": "/api/competitors/[id]", "/api/brain/route": "/api/brain", "/api/competitors/route": "/api/competitors", "/api/auth/signin/route": "/api/auth/signin", "/api/assets/route": "/api/assets", "/api/films/[id]/route": "/api/films/[id]", "/api/films/publish/route": "/api/films/publish", "/api/films/submissions/route": "/api/films/submissions", "/api/missions/[id]/route": "/api/missions/[id]", "/api/links/route": "/api/links", "/api/me/route": "/api/me", "/api/films/select/route": "/api/films/select", "/api/films/route": "/api/films", "/api/missions/route": "/api/missions", "/api/opportunities/[id]/route": "/api/opportunities/[id]", "/api/opportunities/route": "/api/opportunities", "/api/overview/route": "/api/overview", "/api/reviews/route": "/api/reviews", "/api/shared-links/route": "/api/shared-links", "/api/press/[slug]/links/route": "/api/press/[slug]/links", "/api/team/route": "/api/team", "/api/shared-links/[id]/route": "/api/shared-links/[id]", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/_not-found/page": "/_not-found", "/page": "/", "/(app)/assets/page": "/assets", "/(app)/brain/page": "/brain", "/(app)/reviews/page": "/reviews", "/(auth)/signin/page": "/signin", "/(app)/team/page": "/team", "/(app)/films/new/page": "/films/new", "/(app)/campaign/page": "/campaign", "/(app)/films/edit/page": "/films/edit", "/(app)/dashboard/page": "/dashboard", "/(auth)/signup/page": "/signup", "/press/[slug]/page": "/press/[slug]" };
