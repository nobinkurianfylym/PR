...
var AppPathRoutesManifest = { "/api/assets/[id]/route": "/api/assets/[id]", "/api/assets/route": "/api/assets", "/api/auth/signin/route": "/api/auth/signin", "/api/me/route": "/api/me", "/api/missions/[id]/route": "/api/missions/[id]", "/api/auth/signout/route": "/api/auth/signout", "/api/films/route": "/api/films", "/api/auth/signup/route": "/api/auth/signup", "/api/overview/route": "/api/overview", "/api/reviews/route": "/api/reviews", "/api/team/route": "/api/team", "/_not-found/page": "/_not-found", "/page": "/", "/(app)/assets/page": "/assets", "/(app)/campaign/page": "/campaign", "/(app)/reviews/page": "/reviews", "/(auth)/signup/page": "/signup", "/(auth)/signin/page": "/signin", "/(app)/films/new/page": "/films/new", "/(app)/team/page": "/team", "/(app)/dashboard/page": "/dashboard" };
