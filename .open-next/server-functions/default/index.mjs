...
var BuildId = "RoVwtqRRrRvOPnXabP5Jp";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/auth/signin/route": "/api/auth/signin", "/api/assets/route": "/api/assets", "/api/auth/signout/route": "/api/auth/signout", "/api/films/route": "/api/films", "/api/films/[id]/route": "/api/films/[id]", "/api/assets/[id]/route": "/api/assets/[id]", "/api/films/submissions/route": "/api/films/submissions", "/api/films/select/route": "/api/films/select", "/api/films/publish/route": "/api/films/publish", "/api/auth/signup/route": "/api/auth/signup", "/api/me/route": "/api/me", "/api/missions/[id]/route": "/api/missions/[id]", "/api/overview/route": "/api/overview", "/api/links/route": "/api/links", "/api/reviews/route": "/api/reviews", "/api/team/route": "/api/team", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/page": "/", "/(app)/campaign/page": "/campaign", "/(app)/assets/page": "/assets", "/(app)/dashboard/page": "/dashboard", "/(app)/films/edit/page": "/films/edit", "/(app)/reviews/page": "/reviews", "/(auth)/signin/page": "/signin", "/(app)/films/new/page": "/films/new", "/(auth)/signup/page": "/signup", "/(app)/team/page": "/team", "/press/[slug]/page": "/press/[slug]" };
