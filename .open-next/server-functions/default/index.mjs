...
var BuildId = "_WVp7qcEBeVIawGXhcSou";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/assets/[id]/route": "/api/assets/[id]", "/api/assets/route": "/api/assets", "/api/films/[id]/route": "/api/films/[id]", "/api/films/route": "/api/films", "/api/auth/signin/route": "/api/auth/signin", "/api/auth/signout/route": "/api/auth/signout", "/api/me/route": "/api/me", "/api/auth/signup/route": "/api/auth/signup", "/api/team/route": "/api/team", "/api/reviews/route": "/api/reviews", "/api/missions/[id]/route": "/api/missions/[id]", "/api/overview/route": "/api/overview", "/page": "/", "/(app)/campaign/page": "/campaign", "/(app)/assets/page": "/assets", "/(app)/films/new/page": "/films/new", "/(app)/team/page": "/team", "/(app)/reviews/page": "/reviews", "/(app)/dashboard/page": "/dashboard", "/(app)/films/edit/page": "/films/edit", "/(auth)/signin/page": "/signin", "/(auth)/signup/page": "/signup" };
