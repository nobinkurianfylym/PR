...
var BuildId = "QJKOMPOsMCLksrvChu8lV";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/assets/route": "/api/assets", "/api/assets/[id]/route": "/api/assets/[id]", "/api/auth/signin/route": "/api/auth/signin", "/api/auth/signout/route": "/api/auth/signout", "/api/auth/signup/route": "/api/auth/signup", "/api/competitors/route": "/api/competitors", "/api/brain/route": "/api/brain", "/api/competitors/[id]/route": "/api/competitors/[id]", "/api/films/select/route": "/api/films/select", "/api/films/route": "/api/films", "/api/films/[id]/route": "/api/films/[id]", "/api/me/route": "/api/me", "/api/missions/[id]/route": "/api/missions/[id]", "/api/films/publish/route": "/api/films/publish", "/api/films/submissions/route": "/api/films/submissions", "/api/links/route": "/api/links", "/api/opportunities/route": "/api/opportunities", "/api/opportunities/[id]/route": "/api/opportunities/[id]", "/api/overview/route": "/api/overview", "/api/missions/route": "/api/missions", "/api/reviews/route": "/api/reviews", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/api/shared-links/[id]/route": "/api/shared-links/[id]", "/api/press/[slug]/links/route": "/api/press/[slug]/links", "/api/team/route": "/api/team", "/api/shared-links/route": "/api/shared-links", "/page": "/", "/(app)/dashboard/page": "/dashboard", "/(app)/brain/page": "/brain", "/(app)/films/new/page": "/films/new", "/(app)/campaign/page": "/campaign", "/(app)/reviews/page": "/reviews", "/(app)/team/page": "/team", "/press/[slug]/page": "/press/[slug]", "/(app)/assets/page": "/assets", "/press/[slug]/a/[assetId]/page": "/press/[slug]/a/[assetId]", "/(auth)/signup/page": "/signup", "/(auth)/signin/page": "/signin", "/(app)/films/edit/page": "/films/edit" };
