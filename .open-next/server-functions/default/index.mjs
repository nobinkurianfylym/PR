...
var BuildId = "9y9tct225dONcCN6mA4DG";
var HtmlPages = ["/404"];
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/assets", "regex": "^/assets(?:/)?$", "routeKeys": {}, "namedRegex": "^/assets(?:/)?$" }, { "page": "/brain", "regex": "^/brain(?:/)?$", "routeKeys": {}, "namedRegex": "^/brain(?:/)?$" }, { "page": "/campaign", "regex": "^/campaign(?:/)?$", "routeKeys": {}, "namedRegex": "^/campaign(?:/)?$" }, { "page": "/dashboard", "regex": "^/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard(?:/)?$" }, { "page": "/films/edit", "regex": "^/films/edit(?:/)?$", "routeKeys": {}, "namedRegex": "^/films/edit(?:/)?$" }, { "page": "/films/new", "regex": "^/films/new(?:/)?$", "routeKeys": {}, "namedRegex": "^/films/new(?:/)?$" }, { "page": "/reviews", "regex": "^/reviews(?:/)?$", "routeKeys": {}, "namedRegex": "^/reviews(?:/)?$" }, { "page": "/signin", "regex": "^/signin(?:/)?$", "routeKeys": {}, "namedRegex": "^/signin(?:/)?$" }, { "page": "/signup", "regex": "^/signup(?:/)?$", "routeKeys": {}, "namedRegex": "^/signup(?:/)?$" }, { "page": "/team", "regex": "^/team(?:/)?$", "routeKeys": {}, "namedRegex": "^/team(?:/)?$" }], "dynamic": [{ "page": "/api/assets/[id]", "regex": "^/api/assets/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/assets/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/competitors/[id]", "regex": "^/api/competitors/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/competitors/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/films/[id]", "regex": "^/api/films/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/films/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/join/[token]", "regex": "^/api/join/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtoken": "nxtPtoken" }, "namedRegex": "^/api/join/(?<nxtPtoken>[^/]+?)(?:/)?$" }, { "page": "/api/members/[userId]", "regex": "^/api/members/([^/]+?)(?:/)?$", "routeKeys": { "nxtPuserId": "nxtPuserId" }, "namedRegex": "^/api/members/(?<nxtPuserId>[^/]+?)(?:/)?$" }, { "page": "/api/missions/[id]", "regex": "^/api/missions/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/missions/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/opportunities/[id]", "regex": "^/api/opportunities/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/opportunities/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/press/[slug]/links", "regex": "^/api/press/([^/]+?)/links(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/press/(?<nxtPslug>[^/]+?)/links(?:/)?$" }, { "page": "/api/press/[slug]/submit", "regex": "^/api/press/([^/]+?)/submit(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/press/(?<nxtPslug>[^/]+?)/submit(?:/)?$" }, { "page": "/api/shared-links/[id]", "regex": "^/api/shared\\-links/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/shared\\-links/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/join/[token]", "regex": "^/join/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtoken": "nxtPtoken" }, "namedRegex": "^/join/(?<nxtPtoken>[^/]+?)(?:/)?$" }, { "page": "/press/[slug]", "regex": "^/press/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/press/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/press/[slug]/a/[assetId]", "regex": "^/press/([^/]+?)/a/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug", "nxtPassetId": "nxtPassetId" }, "namedRegex": "^/press/(?<nxtPslug>[^/]+?)/a/(?<nxtPassetId>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/assets/route": "/api/assets", "/api/assets/[id]/route": "/api/assets/[id]", "/api/auth/signout/route": "/api/auth/signout", "/api/auth/signin/route": "/api/auth/signin", "/api/competitors/[id]/route": "/api/competitors/[id]", "/api/auth/signup/route": "/api/auth/signup", "/api/films/publish/route": "/api/films/publish", "/api/films/[id]/route": "/api/films/[id]", "/api/competitors/route": "/api/competitors", "/api/films/submissions/route": "/api/films/submissions", "/api/films/route": "/api/films", "/api/brain/route": "/api/brain", "/api/films/select/route": "/api/films/select", "/api/me/route": "/api/me", "/api/join/[token]/route": "/api/join/[token]", "/api/invite/rotate/route": "/api/invite/rotate", "/api/links/route": "/api/links", "/api/members/route": "/api/members", "/api/members/[userId]/route": "/api/members/[userId]", "/api/missions/route": "/api/missions", "/api/opportunities/[id]/route": "/api/opportunities/[id]", "/api/missions/[id]/route": "/api/missions/[id]", "/api/opportunities/route": "/api/opportunities", "/api/overview/route": "/api/overview", "/api/press/[slug]/links/route": "/api/press/[slug]/links", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/api/shared-links/[id]/route": "/api/shared-links/[id]", "/api/reviews/route": "/api/reviews", "/api/shared-links/route": "/api/shared-links", "/api/team/route": "/api/team", "/page": "/", "/join/[token]/page": "/join/[token]", "/press/[slug]/a/[assetId]/page": "/press/[slug]/a/[assetId]", "/press/[slug]/page": "/press/[slug]", "/(app)/assets/page": "/assets", "/(app)/campaign/page": "/campaign", "/(app)/reviews/page": "/reviews", "/(app)/films/new/page": "/films/new", "/(app)/dashboard/page": "/dashboard", "/(app)/team/page": "/team", "/(app)/brain/page": "/brain", "/(auth)/signup/page": "/signup", "/(app)/films/edit/page": "/films/edit", "/(auth)/signin/page": "/signin" };
