...
var BuildId = "L4eHQ4qTk43j616F1SMdo";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/assets/route": "/api/assets", "/api/assets/[id]/route": "/api/assets/[id]", "/api/brain/route": "/api/brain", "/api/auth/signup/route": "/api/auth/signup", "/api/competitors/[id]/route": "/api/competitors/[id]", "/api/competitors/route": "/api/competitors", "/api/auth/signout/route": "/api/auth/signout", "/api/films/[id]/route": "/api/films/[id]", "/api/films/route": "/api/films", "/api/films/publish/route": "/api/films/publish", "/api/links/route": "/api/links", "/api/me/route": "/api/me", "/api/films/submissions/route": "/api/films/submissions", "/api/films/select/route": "/api/films/select", "/api/missions/[id]/route": "/api/missions/[id]", "/api/opportunities/route": "/api/opportunities", "/api/missions/route": "/api/missions", "/api/opportunities/[id]/route": "/api/opportunities/[id]", "/api/reviews/route": "/api/reviews", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/api/shared-links/[id]/route": "/api/shared-links/[id]", "/api/overview/route": "/api/overview", "/api/press/[slug]/links/route": "/api/press/[slug]/links", "/api/shared-links/route": "/api/shared-links", "/api/auth/signin/route": "/api/auth/signin", "/api/team/route": "/api/team", "/page": "/", "/(app)/assets/page": "/assets", "/(app)/dashboard/page": "/dashboard", "/(app)/team/page": "/team", "/(auth)/signin/page": "/signin", "/(auth)/signup/page": "/signup", "/(app)/films/edit/page": "/films/edit", "/(app)/films/new/page": "/films/new", "/(app)/campaign/page": "/campaign", "/(app)/reviews/page": "/reviews", "/(app)/brain/page": "/brain", "/press/[slug]/page": "/press/[slug]", "/press/[slug]/a/[assetId]/page": "/press/[slug]/a/[assetId]" };
