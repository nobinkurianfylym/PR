...
var BuildId = "0924jhiN_VwcFax7MNNp3";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/assets/route": "/api/assets", "/api/assets/[id]/route": "/api/assets/[id]", "/api/auth/signin/route": "/api/auth/signin", "/api/auth/signout/route": "/api/auth/signout", "/api/films/select/route": "/api/films/select", "/api/films/route": "/api/films", "/api/films/submissions/route": "/api/films/submissions", "/api/films/[id]/route": "/api/films/[id]", "/api/films/publish/route": "/api/films/publish", "/api/me/route": "/api/me", "/api/press/[slug]/links/route": "/api/press/[slug]/links", "/api/links/route": "/api/links", "/api/overview/route": "/api/overview", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/api/shared-links/[id]/route": "/api/shared-links/[id]", "/api/missions/[id]/route": "/api/missions/[id]", "/api/shared-links/route": "/api/shared-links", "/api/reviews/route": "/api/reviews", "/api/auth/signup/route": "/api/auth/signup", "/api/team/route": "/api/team", "/page": "/", "/(app)/campaign/page": "/campaign", "/(app)/films/new/page": "/films/new", "/(app)/team/page": "/team", "/(app)/assets/page": "/assets", "/(auth)/signin/page": "/signin", "/(app)/films/edit/page": "/films/edit", "/(app)/reviews/page": "/reviews", "/(app)/dashboard/page": "/dashboard", "/(auth)/signup/page": "/signup", "/press/[slug]/page": "/press/[slug]" };
