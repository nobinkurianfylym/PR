...
var BuildId = "IkOA1u3PpmhFiIKqnI1ux";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/assets/[id]/route": "/api/assets/[id]", "/api/assets/route": "/api/assets", "/api/brain/route": "/api/brain", "/api/auth/signup/route": "/api/auth/signup", "/api/competitors/route": "/api/competitors", "/api/auth/signin/route": "/api/auth/signin", "/api/competitors/[id]/route": "/api/competitors/[id]", "/api/films/select/route": "/api/films/select", "/api/films/route": "/api/films", "/api/auth/signout/route": "/api/auth/signout", "/api/films/[id]/route": "/api/films/[id]", "/api/me/route": "/api/me", "/api/links/route": "/api/links", "/api/films/publish/route": "/api/films/publish", "/api/films/submissions/route": "/api/films/submissions", "/api/missions/route": "/api/missions", "/api/missions/[id]/route": "/api/missions/[id]", "/api/opportunities/route": "/api/opportunities", "/api/opportunities/[id]/route": "/api/opportunities/[id]", "/api/press/[slug]/links/route": "/api/press/[slug]/links", "/api/reviews/route": "/api/reviews", "/api/shared-links/[id]/route": "/api/shared-links/[id]", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/api/overview/route": "/api/overview", "/api/team/route": "/api/team", "/api/shared-links/route": "/api/shared-links", "/page": "/", "/(app)/brain/page": "/brain", "/(app)/campaign/page": "/campaign", "/(app)/assets/page": "/assets", "/(app)/dashboard/page": "/dashboard", "/(app)/reviews/page": "/reviews", "/(auth)/signin/page": "/signin", "/(app)/team/page": "/team", "/(app)/films/edit/page": "/films/edit", "/(app)/films/new/page": "/films/new", "/(auth)/signup/page": "/signup", "/press/[slug]/page": "/press/[slug]" };
