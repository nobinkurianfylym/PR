...
var BuildId = "1q9OQtz0s4KhBww0b_RFr";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/api/assets/route": "/api/assets", "/api/assets/[id]/route": "/api/assets/[id]", "/api/auth/signin/route": "/api/auth/signin", "/api/auth/signout/route": "/api/auth/signout", "/api/auth/signup/route": "/api/auth/signup", "/api/brain/route": "/api/brain", "/api/competitors/route": "/api/competitors", "/api/competitors/[id]/route": "/api/competitors/[id]", "/api/films/[id]/route": "/api/films/[id]", "/api/films/publish/route": "/api/films/publish", "/api/films/select/route": "/api/films/select", "/api/films/route": "/api/films", "/api/films/submissions/route": "/api/films/submissions", "/api/me/route": "/api/me", "/api/links/route": "/api/links", "/api/missions/[id]/route": "/api/missions/[id]", "/api/missions/route": "/api/missions", "/api/opportunities/[id]/route": "/api/opportunities/[id]", "/api/opportunities/route": "/api/opportunities", "/api/overview/route": "/api/overview", "/api/press/[slug]/submit/route": "/api/press/[slug]/submit", "/api/press/[slug]/links/route": "/api/press/[slug]/links", "/api/reviews/route": "/api/reviews", "/_not-found/page": "/_not-found", "/api/shared-links/[id]/route": "/api/shared-links/[id]", "/api/shared-links/route": "/api/shared-links", "/api/team/route": "/api/team", "/page": "/", "/(app)/assets/page": "/assets", "/(app)/campaign/page": "/campaign", "/(app)/dashboard/page": "/dashboard", "/(app)/brain/page": "/brain", "/(app)/films/edit/page": "/films/edit", "/(app)/films/new/page": "/films/new", "/(app)/reviews/page": "/reviews", "/(app)/team/page": "/team", "/(auth)/signin/page": "/signin", "/(auth)/signup/page": "/signup", "/press/[slug]/a/[assetId]/page": "/press/[slug]/a/[assetId]", "/press/[slug]/page": "/press/[slug]" };
